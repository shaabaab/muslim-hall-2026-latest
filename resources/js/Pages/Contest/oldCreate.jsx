        ...
        >
            <Card>
                ...
                >
                    ...
                    {/* Hold Contest Switch */}
                    {/* <Form.Item
                        label="Contest Hold Status"
                        validateStatus={errors.is_on_hold ? 'error' : ''}
                        help={errors.is_on_hold}
                    >
                        <Space direction="vertical" style={{ width: '100%' }}>
                            <Switch
                                checked={data.is_on_hold}
                                onChange={handleHoldWithConfirm}
                                checkedChildren={<PauseOutlined />}
                                unCheckedChildren={<PlayCircleOutlined />}
                                style={{ marginRight: 8 }}
                            />
                            <Text type={data.is_on_hold ? "warning" : "secondary"}>
                                {data.is_on_hold 
                                    ? "Contest will be created on hold - users cannot participate" 
                                    : "Contest will be active - users can participate"
                                }
                            </Text>
                        </Space>
                    </Form.Item> */}
                    ...
                    {/* Conditionally render Amount field only for paid contests */}
                    {isPaidContest && (
                        <Form.Item
                            label="Amount"
