...
export default function Show({ contest, auth }) {
    const handleDelete = () => {
        router.delete(route("user.contests.destroy", contest.id), {
            onSuccess: () => {
    ...
    return (
        <FrontAuthenticatedLayout user={auth.user} header="Contest Details">
            <Card>
                <div className="lg:flex-row lg:gap-0 gap-4  flex-col-reverse flex justify-between items-center mb-6">
                    <div>
                        <Title level={2} className="mb-2">
                            <FileTextOutlined className="mr-2 lg:text-left text-center" />
                    ...
                    <Space className="flex flex-col md:flex-row md:justify-end justify-between items-center w-full   ">
                ...
                <div className="flex justify-center">
                    <Space>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                window.open(
                                    route("user.contests.preview", contest.id),
                                    "_blank",
                                )
                            }
                        >
