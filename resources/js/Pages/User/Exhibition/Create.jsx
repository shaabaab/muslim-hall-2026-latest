        ...
        if (selectedBoard.is_owner) {
            return (
                <Alert
                    ...
                    showIcon
                    className="mb-4"
                    message="Your own board selected"
                    description="Only exhibition admin approval is needed."
                />
            );
        }
        ...
        if (selectedBoard.can_post_now) {
            return (
                <Alert
                    ...
                    showIcon
                    className="mb-4"
                    message="Approved member board selected"
                    description="You already have board permission. Only exhibition admin approval is needed."
                />
            );
        }
        ...
        <Authenticated user={auth.user} header="Create Exhibition Item">
            <Card>
                <div className="mb-6">
                    ...
                    <Title level={3}>
                        <EditOutlined className="mr-2" /> Create New Exhibition
                        Item
                    </Title>
                    <Text type="secondary">
                        Create a new board or use another member board from this
                        same page.
                    </Text>
                </div>
                ...
                <Form layout="vertical" onFinish={submit} className="max-w-5xl">
                            ...
                            <>
                                {boards.length === 0 && (
                                    <Alert
                                        ...
                                        showIcon
                                        className="mb-4"
                                        message="No approved boards found"
                                        description="You can create a new board from this page."
                                    />
                                )}
                                <Form.Item
                                    label="Exhibition Board"
                                    validateStatus={
                                        errors.exhibition_board_id
                                            ? "error"
                                            : ""
                                    }
                                ...
                                {!selectedBoard?.is_owner &&
                                    selectedBoard &&
                                    !selectedBoard?.can_post_now && (
                                        <Form.Item
                                            label="Message for Board Owner/Admin"
                                            validateStatus={
                                                errors.board_request_message
                                                    ? "error"
                                                    : ""
                                            }
                                        ...
                                        >
                                            <Input.TextArea
                                                ...
                                                placeholder="Why do you want to post on this board?"
                                            />
                                        </Form.Item>
                                    )}
                            </>
                            ...
                            <Row gutter={16}>
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        ...
                                        required
                                        validateStatus={
                                            errors.new_board_title
                                                ? "error"
                                                : ""
                                        }
                                        help={errors.new_board_title}
                                    >
                                        <Input
                                            size="large"
                                            value={data.new_board_title}
                                            onChange={(e) =>
                                                setData(
                                                    "new_board_title",
                                                    e.target.value,
                                ...
                                <Col xs={24} md={12}>
                                    <Form.Item
                                        label="New Board Image"
                                        validateStatus={
                                            errors.new_board_image
                                                ? "error"
                                                : ""
                                        }
                                        help={errors.new_board_image}
                                    >
                                        <Upload
                                            beforeUpload={(file) =>
                                                setFile(
                                ...
                                <Col span={24}>
                                    <Form.Item
                                        ...
                                        validateStatus={
                                            errors.new_board_description
                                                ? "error"
                                                : ""
                                        }
                                        help={errors.new_board_description}
                                    >
                                        <Input.TextArea
                                            rows={3}
                                            value={data.new_board_description}
                                            onChange={(e) =>
                                                setData(
                                                    "new_board_description",
                                                    e.target.value,
                    ...
                    <Alert
                        ...
                        description="Member exhibition is always saved as Draft/Pending. Admin will publish after required approvals."
                    />
