...
export default function Index({ posts, filters, auth }) {
    ...
    const handleDelete = (id) => {
        router.delete(route("user.communities.delete", id), {
            onSuccess: () => {
            ...
            render: (_, record) => (
                <Space size="small">
                    {/* <Tooltip title="View Post">
                        <Link href={route("user.communities.show", record.id)}>
                            <Button
                                type="primary"
                                icon={<EyeOutlined />}
                                size="small"
                    ...
                    <Tooltip title="Edit Post">
                        <Link href={route("user.communities.edit", record.id)}>
        ...
        <Authenticated user={auth.user} header="Community Management">
            <Card>
                ...
                <div className="flex sm:flex-row flex-col gap-3 justify-between items-center mb-6">
                    ...
                    <Link href={route("user.communities.create")}>
                        <Button
                            type="primary"
                            icon={<PlusOutlined />}
                            size="large"
