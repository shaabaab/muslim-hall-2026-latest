...
export default function Index({ resources, filters, auth }) {
    const handleDelete = (id) => {
        router.delete(route("user.islamic-zone.destroy", id), {
            onSuccess: (success) => {
                message.success(
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="small">
                    {/* <Tooltip title="View">
                        <Link href={route('user.islamic-zone.show', record.id)}>
                            <Button icon={<EyeOutlined />} size="small" />
                        </Link>
                    </Tooltip>
                    
                    <Tooltip title="Download">
                        <Link href={route('user.islamic-zone.download', record.id)}>
                    ...
                    <Tooltip title="Edit">
                        <Link
                            href={route("user.islamic-zone.edit", record.id)}
                        >
