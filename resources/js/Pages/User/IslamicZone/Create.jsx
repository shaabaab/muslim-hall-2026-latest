...
export default function Create({ auth, langs }) {
    ...
    const submit = async () => {
        ...
        try {
            ...
            // Fix: correct store URL — route maps to POST /user/islamic-zone (not /store)
            const storeUrl = typeof route === 'function' ? route("user.islamic-zone.store") : "/user/islamic-zone";
    ...
    const renderMediaFields = () => {
        return (
            <>
                <Col span={24}>
                    <Divider orientation="left">All Media Uploads</Divider>
                    <Text type="secondary" className="block mb-4">
                        User side will submit as Draft for admin approval, but all admin media options are available here: image gallery, document/PDF, audio, video, and YouTube URL.
                    </Text>
                </Col>
                    ...
                    >
                        ...
                        {documentPreview && (
                            <div className="mt-3">
                                ...
                                <Text>{documentPreview.name || documentPreview}</Text>
                    ...
                    <Col span={24}>
                        ...
                        >
                            ...
                            {galleryPreviews.length > 0 && (
                                <div className="mt-4">
                                    <Text strong className="block mb-2">Selected Images:</Text>
                            ...
                            >
                                ...
                                {documentPreview && (
                                    <div className="mt-3">
                                        <Text strong>Selected: </Text>
                                        <Text>{documentPreview.name || documentPreview}</Text>
                                        <Button type="link" danger icon={<DeleteOutlined />} onClick={handleDocumentRemove}>Remove</Button>
                                    </div>
                                )}
                            </Form.Item>
                        </Col>
            ...
            <Card>
                ...
                <Form layout="vertical" onFinish={submit} className="max-w-4xl">
                    <Row gutter={24}>
                        ...
                        {contentType && !["quran", "hadith"].includes(contentType) && renderMediaFields()}
                            ...
                            <Form.Item label="Status">
                                <Card size="small" className="bg-yellow-50 border-yellow-200">
                                    ...
                                    <Text type="secondary" className="block">
                                        User Islamic Zone content always submits as Draft. Admin will review and publish it.
                                    </Text>
                                </Card>
                            </Form.Item>
                        </Col>
